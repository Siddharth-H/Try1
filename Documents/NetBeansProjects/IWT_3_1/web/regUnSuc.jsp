...
<html>
    ...
    <center>
        <div style="color: black;"><h1>Registration Unsuccessful</h1></div>
        <h2 style="color: black;" >Go back to <a href="register3.jsp">Registration page</a></h2>
        <h2 style="color: black;"><% out.println(message); %></h2>
    </center>
        <!--<h2 style="color: black;" >Go to <a href="register3.jsp"> page</a></h2>-->
    <footer>
